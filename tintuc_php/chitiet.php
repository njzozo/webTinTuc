    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <!-- Preview Image -->
                <img class="img-responsive" src="public/image/tintuc/<?=$chitietTin->Hinh?>" alt="" style=" height: auto; width: 900px; max-height: 400px" ">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                            ...
                            <div class="row" style="margin-top: 10px;">
                                <div class="col-md-5">
                                    <a href="chitiet.php?loai_tin=<?=$noibat->TenKhongDau?>&id_tin=<?=$noibat->id?>">
                                        <img class="img-responsive" src="public/image/tintuc/<?=$noibat->Hinh?>" alt="">
                                    </a>
                                </div>
                                <div class="col-md-7">
                                    <a href="chitiet.php?loai_tin=<?=$noibat->TenKhongDau?>&id_tin=<?=$noibat->id?>"><b><?=$noibat->TieuDe?></b></a>
                                </div>
